...
REM
REM Generated by Vivado on Wed May 06 18:12:23 -0300 2026
...
echo "xvhdl --incr --relax -prj nrz_l_tb_vhdl.prj"
call xvhdl  --incr --relax -prj nrz_l_tb_vhdl.prj -log xvhdl.log
