...
HD_PWD='C:/Users/081230039/Downloads/nrz-project-2026/nrz-project-2026-main/NRZ-I Project/Projeto NRZ-I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_i.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrz_i.tcl -notrace
