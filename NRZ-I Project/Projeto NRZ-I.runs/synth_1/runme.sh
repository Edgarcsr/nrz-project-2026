...
HD_PWD='C:/Users/081230039/Downloads/nrz-project-2026/nrz-project-2026-main/NRZ-I Project/Projeto NRZ-I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nrz_i.tcl
