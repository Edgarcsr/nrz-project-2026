...
REM
REM Generated by Vivado on Wed May 06 18:28:08 -0300 2026
...
echo "xvhdl --incr --relax -prj nrz_i_tb_vhdl.prj"
call xvhdl  --incr --relax -prj nrz_i_tb_vhdl.prj -log xvhdl.log
